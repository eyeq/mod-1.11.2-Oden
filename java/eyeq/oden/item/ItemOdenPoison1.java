...
public class ItemOdenPoison1 extends UItemSwordFood {
    public ItemOdenPoison1(ToolMaterial material, int amount, float saturation) {
        ...
        this.setPotionEffect(new PotionEffect(MobEffects.POISON, 300, 1), 1.0F);
