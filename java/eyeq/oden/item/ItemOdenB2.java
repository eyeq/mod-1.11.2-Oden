...
public class ItemOdenB2 extends UItemSwordFood {
    public ItemOdenB2(ToolMaterial material, int amount, float saturation) {
        super(material, amount, saturation);
        this.setNoRepair();
        this.setEatPotionEffect(new PotionEffect(MobEffects.FIRE_RESISTANCE, 1800, 0), 0.3F);
        this.setPotionEffect(new PotionEffect(MobEffects.JUMP_BOOST, 200, 20), 1.0F);
